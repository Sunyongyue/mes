...
public class myIndexController {
    ...
    public String indexValue(){
       ...
       /* System.out.println("day: "+day+"month: "+month+"year: "+year);*/
        ...
        int industryWeekOrder = valueService.industryWeekOrder();
        int civilWeekOrder = valueService.civilWeekOrder();
        int industrySaleWeekOrder = valueService.industrySaleWeekOrder();
        int civilSaleWeekOrder = valueService.civilSaleWeekOrder();
        int weekCivilSendGoods = valueService.weekCivilSendGoods();
        int weekDustrySendGoods = valueService.weekDustrySendGoods();
        object.put("success",1);
        object.put("industryWeekOrder",industryWeekOrder);
        object.put("civilWeekOrder",civilWeekOrder);
        object.put("industrySaleWeekOrder",industrySaleWeekOrder);
        object.put("civilSaleWeekOrder",civilSaleWeekOrder);
        object.put("weekCivilSendGoods",weekCivilSendGoods);
        object.put("weekDustrySendGoods",weekDustrySendGoods);

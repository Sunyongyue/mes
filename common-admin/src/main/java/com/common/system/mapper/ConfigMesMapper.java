...
public interface ConfigMesMapper {
    ...
    List<ConfigMes> queryForIot(@Param("confDeviceAddr") String confDeviceAddr);
    ...
    int updateConfigMesStatus(@Param("confDeviceAddr") String confDeviceAddr,@Param("pktSer") int pktSer,@Param("status") int status);
}
